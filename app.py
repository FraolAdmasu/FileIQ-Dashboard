...
if page == "File & Folder Analysis":
    ...
    st.markdown("Upload a ZIP file or enter a folder path to generate insights.")
    ...
    with col2:
        st.markdown(
            """
            <div style="background: #f5f5fc; border-radius: 10px; padding: 1em; border-left: 8px solid #8b5cf6;">
                <span style="font-size:1.15em;"><b>🚀 Advanced: Analyze a Folder Path</b></span>
                <br>
                Enter an <b>absolute path</b> on this server or your computer.<br>
                <ul style="margin-top:8px;margin-bottom:4px;line-height:1.5;">
                    <li>🔹 <b>Cloud/Hosted app</b>: Only server folders are accessible.<br>Example: <code>/mount/src/documents</code></li>
                    <li>🔹 <b>Local run</b>: Enter any folder path from your computer.<br>Example: <code>C:\\Users\\myname\\Documents</code> (Windows) or <code>/Users/myname/Documents</code> (Mac/Linux)</li>
                    <li>🔹 <b>Tip</b>: For your own files, <b>ZIP and upload</b> for analysis if you can't access the folder directly.</li>
                </ul>
            </div>
            """,
        ...
        folder_path = st.text_input(
            "Enter folder path for analysis (advanced)", 
            placeholder="/path/to/your/folder",
            key="folder_path_manual"
        )
        if folder_path:
        ...
        with st.expander("❓ Need help?"):
            st.markdown("""
            - Cloud/Deployed: Only server's own files can be scanned by path.
            - If you want to analyze your local files, compress them into a `.zip` then use the uploader.
            - Contact admin if you need additional network shares or drives mounted.
            """)
